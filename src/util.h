 ...
 */
#ifndef EREXCOIN_UTIL_H
#define EREXCOIN_UTIL_H
...
extern const char * const EREXCOIN_CONF_FILENAME;
extern const char * const EREXCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("erexcoin-%s", name);
