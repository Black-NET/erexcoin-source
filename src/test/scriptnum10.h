...
#ifndef EREXCOIN_TEST_SCRIPTNUM10_H
#define EREXCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from ErexCoin Core 0.10.0, for cross-comparison.
 */
public:
