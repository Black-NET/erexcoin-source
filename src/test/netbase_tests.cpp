...
{
    BOOST_CHECK(TestSplitHost("www.erexcoincore.org", "www.erexcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.erexcoincore.org]", "www.erexcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.erexcoincore.org:80", "www.erexcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.erexcoincore.org]:80", "www.erexcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:17482", "127.0.0.1", 17482));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:17482", "127.0.0.1", 17482));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:17482", "::ffff:127.0.0.1", 17482));
    BOOST_CHECK(TestSplitHost("[::]:17482", "::", 17482));
    BOOST_CHECK(TestSplitHost("::17482", "::17482", -1));
    BOOST_CHECK(TestSplitHost(":17482", "", 17482));
    BOOST_CHECK(TestSplitHost("[]:17482", "", 17482));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:17482", "127.0.0.1:17482"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:17482", "[::]:17482"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
