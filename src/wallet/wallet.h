...
#ifndef EREXCOIN_WALLET_WALLET_H
#define EREXCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this erexcoin node, and set to 0 for transactions that were created
...
#endif // EREXCOIN_WALLET_WALLET_H
