...
static void SetupErexCoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " erexcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  erexcoin-tx [options] <hex-tx> [commands]  Update hex-encoded erexcoin transaction\n" +
            "or:     erexcoin-tx [options] -create [commands]   Create hex-encoded erexcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded erexcoin transaction
