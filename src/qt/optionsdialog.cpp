    ...
    mapper(0)
{
    ...
    ui->erexcoinAtStartup->setToolTip(ui->erexcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->erexcoinAtStartup->setText(ui->erexcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openErexCoinConfButton->setToolTip(ui->openErexCoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ErexCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->erexcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openErexCoinConfButton_clicked()
{
