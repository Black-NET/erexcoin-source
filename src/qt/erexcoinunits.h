...
#ifndef EREXCOIN_QT_EREXCOINUNITS_H
#define EREXCOIN_QT_EREXCOINUNITS_H
...
/** ErexCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ErexCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ErexCoinUnits(QObject *parent);

    /** ErexCoin units.
      @note Source: https://en.erexcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        EREX,
...
typedef ErexCoinUnits::Unit ErexCoinUnit;

#endif // EREXCOIN_QT_EREXCOINUNITS_H
