...
#ifndef EREXCOIN_INTERFACES_NODE_H
#define EREXCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a erexcoin node (erexcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // EREXCOIN_INTERFACES_NODE_H
