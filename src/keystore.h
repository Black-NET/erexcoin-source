...
#ifndef EREXCOIN_KEYSTORE_H
#define EREXCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/erexcoin/bips/blob/master/bip-0013.mediawiki
