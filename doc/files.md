...
* erexcoin.conf: contains configuration settings for erexcoind or erexcoin-qt
* erexcoind.pid: stores the process id of erexcoind while running
...
* debug.log: contains debug information and general logging generated by erexcoind or erexcoin-qt
