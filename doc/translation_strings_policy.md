...
This document provides guidelines for internationalization of the ErexCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `erexcoin_en.ts` remains unchanged.
