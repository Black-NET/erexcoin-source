...
"""Verify that starting erexcoin with -h works as expected."""

from test_framework.test_framework import ErexCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ErexCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start erexcoin with -h for help text")
        ...
        self.log.info("Start erexcoin with -version for version information")
        ...
        self.log.info("Start erexcoind with -fakearg to make sure it does not start")
