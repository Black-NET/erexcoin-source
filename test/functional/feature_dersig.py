...
class BIP66Test(ErexCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # erexcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and erexcoind produces more specific reject
            # reasons.
