...
# TestP2PConn: A peer we use to send messages to erexcoind, and store responses.
...
class CompactBlocksTest(ErexCoinTestFramework):
    ...
    # This test actually causes erexcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that erexcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for erexcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # erexcoind will not send blocktxn responses for blocks whose height is
